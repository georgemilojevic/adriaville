...
return [
    ...
    */
    ...
    'googlemaps' => [
         'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyCqbtTa7CRXUADzqKTJyQZ_TkD7itNHcCM'),
         'center' => [
             'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '44.715738'),
             'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '20.161084'),
         ],
